...
## Changelog
- **v1.2.4** added a picture of the online store manager
...
- **v1.0:** Created the Dry Point six-page website structure, catalogue, cart section, payment, contact page, sitemap, about page and README.
